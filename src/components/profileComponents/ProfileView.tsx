...
const MenuItem: React.FC<MenuItemProps> = ({ icon, label, onPress, color, showDivider = true }) => {
  ...
  return (
    <View>
      ...
      {showDivider && <View style={[styles.menuItemDivider, { backgroundColor: colors.divider }]} />}
    </View>
  );
};
    ...
    >
      ...
      <Animated.View entering={FadeInDown.delay(100).duration(600).springify()}>
        ...
        <View style={[styles.menuContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <MenuItem icon="gift" label="Coupons & Offers" color="#FF6B6B" showDivider={false} />
        </View>
      </Animated.View>
      ...
      <Animated.View entering={FadeInDown.delay(200).duration(600).springify()}>
        ...
        <View style={[styles.menuContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <MenuItem icon="card" label="Payment Methods" color="#4facfe" showDivider={false} />
        </View>
      </Animated.View>
      ...
      <Animated.View entering={FadeInDown.delay(300).duration(600).springify()}>
        ...
        <Appearance />
        <View style={[styles.menuContainer, { backgroundColor: colors.surface, borderColor: colors.border, marginTop: 16 }]}>
          <MenuItem icon="settings" label="Settings" color="#636e72" showDivider={false} />
        </View>
      </Animated.View>
      ...
      <Animated.View entering={FadeInDown.delay(400).duration(600).springify()}>
        ...
        <View style={[styles.menuContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <MenuItem icon="chatbubble-ellipses" label="Your Feedback" color="#00b894" />
          <MenuItem icon="help-circle" label="Send Feedback" color="#0984e3" showDivider={false} />
        </View>
      </Animated.View>
      ...
      <Animated.View entering={FadeInDown.delay(500).duration(600).springify()}>
        ...
        <View style={[styles.menuContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <MenuItem icon="information-circle" label="About" color="#636e72" showDivider={false} />
        </View>
      </Animated.View>

      <Animated.View entering={FadeInDown.delay(600).duration(600).springify()} style={{ marginTop: 40 }}>
        <Logout />
      </Animated.View>
    </ScrollView>
  );
